    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-24 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <div className="inline-flex items-center gap-2 bg-amber-500/10 text-amber-400 border border-amber-500/20 rounded-full px-4 py-1.5 text-sm font-medium mb-8">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
            ...
            <br />
            <span className="text-amber-500">Get paid without banks.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link href="/explore" className={buttonVariants({ size: 'lg', className: 'bg-amber-500 hover:bg-amber-400 text-slate-900 font-semibold px-8' })}>
              Browse Jobs
            </Link>
            <Link href="/jobs/new" className={buttonVariants({ variant: 'outline', size: 'lg', className: 'border-slate-600 text-slate-200 hover:bg-slate-800 px-8' })}>
              Post a Job
            </Link>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={num} className="bg-slate-800/50 border-slate-700">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden">
            <div className="grid grid-cols-3 bg-slate-800 px-6 py-3 text-sm font-semibold">
              ...
              <span className="text-amber-500 text-center">WorkChain</span>
